...
<div id="toc">
  <ul align="center" style="list-style: none">
    <summary>
      <h1>
        👋 Hi, My Name is Mohammad Sahil Khan
      </h1>
    </summary>
  </ul>
</div>
...
💼 I'm currently working on: **🌐 Building AI-powered web applications using FastAPI**<br>
🌱 I'm currently learning:<br> **- Python (Advanced + OOP)<br> - Machine Learning (Scikit-learn)<br> - FastAPI & Backend Development <br>- Generative AI & Prompt Engineering**<br>
💬 Ask me about:<br> **- Python Programming<br> - Machine Learning Basics<br> - AI Project Development<br> - Git & GitHub<br> - Building AI Web Applications**
